...
abstract base class TestRpcContract extends RpcServiceContract {
  ...
  Future<RpcClientStreamResult<TestRequest, TestResponse>>
      clientStreamOperation(
    RpcClientStreamParams<TestRequest, TestResponse> params,
  );

  Stream<TestStreamResponse> serverStreamOperation(TestRequest request);
...
final class ServerTestRpcService extends TestRpcContract {
  ...
  Future<RpcClientStreamResult<TestRequest, TestResponse>>
    ...
    final requestStream = params.stream!;
    ...
    return RpcClientStreamResult(response: Future.value(response));
  }

  @override
  Stream<TestStreamResponse> serverStreamOperation(TestRequest request) async* {
...
final class ClientTestRpcService extends TestRpcContract {
  ...
  @override
  Stream<TestStreamResponse> serverStreamOperation(
    TestRequest request,
  ) {
    return _endpoint
        .serverStreaming(
